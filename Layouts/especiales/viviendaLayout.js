...
import ViviendaHeader from "component/Page_Vivienda/LayoutElements/Header/Header";
import ViviendaFooter from "../../component/Page_Vivienda/LayoutElements/Footer/Footer";

const ViviendaLayout = ({ children, adsPage, data, prebid }) => {
