...
function initPrebid() {
    ...
    var sizeBidder = (bidder) => {
        if (bidder && Object.keys(bidder)) {
            ...
            if (bidder["oftmedia"] && Object.keys(bidder["oftmedia"]) && Object.keys(bidder["oftmedia"]).length) {
                let placementCode_oftMedia

                if (isPhone && bidder["oftmedia"]["mobile"]) {
                    placementCode_oftMedia = bidder["oftmedia"]["mobile"]["id"];
                } else if (bidder["oftmedia"]["desktop"]) {
                    placementCode_oftMedia = bidder["oftmedia"]["desktop"]["id"];
                }
                const oftMedia = {
                    bidder: "oftmedia",
                    params: {
                        placementId: placementCode_oftMedia,
                    }
                }
                arrayBidder.push(oftMedia);
            }
            return arrayBidder
        }
    }
